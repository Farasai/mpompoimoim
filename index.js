...
const token = 'MzA4MTE5MDk2NDA1MzkzNDA4.DAJawA.tFrTO4Bm2uRUUIksT62kteQTjNg'
...
var newUsers = [];
const aa = [];
const bypass = [". c o m", ".c o m", ". co m", ". c om", ".co m", ".c om", ". com", ".c o m", ". n e t", ".n e t", ". ne t", ". n et", ". n et", ".n e t", ". o r g", ".o r g", ". or g", ". o rg", ". o rg", ".o r g", "(dot)com", "(dot)net", "(dot)org", "(d0t)com", "(d0t)net", "(d0t)org", "titik", ",com", ",co m", ", c o m", ",c o m", ".cum", ".c u m", ".cu m", "(doot)com", "(doot)net", "(doot)org", ",cum", "_com", "_cum", "(doot)cam", "(doot)cum", "*com", "-com", "-cum", "-coom", "_coom", "(doot)coom", "(dat)com", "(dat)cum", "(dat)cam", "(dat)net", "(dat)net", "(dat)org", ".clum", ",clum", "(doot)clum", "(dot)clum", "(d00t)clum", "(d0t)clum", "puntcom", "puntnet", "puntorg", "punt)com", "punt)net", "punt)org", "*net", "*org", ".c.o.m", ".n.e.t", ".o.r.g", ".co(", ".ne(", ".org(", "..com", "...com", "....com", ".....com", "......com", ". .com", "(dot) com", "(dot) c o m", "(d0t) com", "(d0t) c o m", ")com", ")net", ")org", ". cum"]

music(bot)
bot.on('ready', () => {
console.log("The bot is up! - on " + bot.guilds.size + " servers. (2 testing servers, 9gag)")
...
bot.on("message", message => {
    ...
    if (message.content.startsWith(prefix + 'wiki')) {
        var wht = message.content.replace("?wiki ", "")
        message.reply("https://en.m.wikipedia.org/wiki/" + wht)
    }
    ...
    if (bypass.some(bypass => message.content.toLowerCase().includes(bypass))) {
        message.guild.channels.find('name', 'nsfw-moderation-room').sendMessage("📋 **[BYPS]** " + message.author + " has attempted to **bypass** Ava's link restrictions in the channel <#" + message.channel.id + "> with the usage of:\n```" + message.content + "```")
        return message.reply("P-Please don't try b-bypassing <@228037172836433920>..").then(m => m.delete(10000).then(message.delete()));
}
if (message.content.toLowerCase() === 'ara sucks') {
    message.reply("I-I try my b-best.. <:arablush:313984062832508929>").then(m => m.delete(10000))
}
    if (message.content.startsWith(prefix + 'stream')) {
if (message.author.id !== '220563848380284930' && message.author.id !== '222575104297533441' && message.author.id !== '213836424170962944') return;
    var thingidk = message.content.replace("?stream ", "")
    bot.user.setGame(thingidk, 'https://twitch.tv/twitch')   
    message.reply(":+1:") 
    }
    ...
    if (message.content.startsWith(prefix + 'kick')) { // If the message starts with "?kick", then;
        ...
        member.kick().then(() => { // Else, if they did put a user-- kick the member mentioned, then say
            message.reply("`" + user.username + "#" + user.discriminator + "` has been kicked! 👍").then(m => m.delete(10000)); // this.
            message.delete();
        });
    }
    if (message.content.toLowerCase().startsWith(prefix + 'purge')) {
        ...
        if (!permsbot) {
            message.delete()
            return message.reply("Nooo! <:arablush:313984062832508929>\n*An error occured..*").then(m => m.delete(10000));
            message.delete()
        }
        if (amount < 1) {
            console.log("Reject for amount under 1.")
            return message.reply("I-I couldn't find a-anything to purge.. <:arablush:313984062832508929>").then(m => m.delete(10000));
            message.delete()
        }
        if (amount > 100) {
            console.log("Reject for amount over 100.")
            return message.reply("Y-You went o-over 100.. <:arablush:313984062832508929>").then(m => m.delete(10000));
            message.delete()
        }
        if (isNaN(amount)) return message.reply("T-That isn't a number.. <:arablush:313984062832508929>")
        message.delete()
        console.log("Deleted message.")
        message.channel.bulkDelete(amount)
        console.log("Pruned amount.")
        message.reply("Y-Yes! I finally d-did it! I-I purged " + amount + " messages! <:ara:310244084986019840>").then(m => m.delete(5000));
    ...
    if (message.content.startsWith(prefix + 'ban')) { // If the message starts with "?kick", then;
        ...
        member.ban().then(() => { // Ban the member, then say
            message.reply("`" + user.username + "#" + user.discriminator + "` has been banned! 👍").then(m => m.delete(10000));
    ...
    if (message.content.startsWith(prefix + 'unban')) {
        ...
        message.reply("This user has been unbanned! 👍").then(m => m.delete(10000));
    }
        ...
        if (guild) {
            ...
            message.delete();
             message.channel.overwritePermissions(user, {
                    SEND_MESSAGES: false
                }).then(message.reply("`" + user.username + "#" + user.discriminator + "` has been muted! 👍")).then(m => m.delete(10000)); // this.
        }
    } else {}
    if (message.content.startsWith(prefix + 'warn')) {
        ...
        message.delete();
        message.reply(`Added warning to user \`${user.username}#${user.discriminator}\`! \`ðŸ‘\``).then(m => m.delete(10000));
    ...
    if (message.content.startsWith(prefix + 'unmute')) { // If the message starts with unmute
        ...
        var permsbot = message.guild.member(bot.user).hasPermission('CHANGE_NICKNAME') // If the bot has the Mute Members permission
        if (!permsbot)
        ...
        if (!memberRemove) {
         ...
         message.channel.overwritePermissions(user, {
            SEND_MESSAGES: true
                }).then(message.reply("`" + user.username + "#" + user.discriminator + "` has been unmuted! 👍")).then(m => m.delete(10000)); // this.
        }
    ...
    if (message.content.startsWith(prefix + 'match')) {
        ...
        message.delete();
        if (lovebird)
            message.reply("The rate between your relationship is `" + Math.floor((Math.random() * 100) + 0) + "%` 😊").then(m => m.delete(10000));
        message.delete();
    }
    var user = message.mentions.users.first();
    ...
    if (message.content.toLowerCase().startsWith('trump')) {
        return message.channel.sendMessage(message.author + ", Y-You're fired.").then(m => m.delete(10000)).then(message.react("🔥"))
    }
    ...
    if (message.content.toLowerCase() === prefix + 'help') {
        ...
        "\nf      ::       pay your respects!" +
        "\nsmug   ::       get a random picture of a smug anime girl!" +
        "\n= ..and other secrets =```"]);
        message.react("👌")
    }
    ...
    if (pornlinks.some(pornlinks => message.content.includes(pornlinks))) {
        message.delete();
        message.guild.channels.find('name', 'nsfw-moderation-room').sendMessage(":warning: " + message.author + " has posted a link leading to pornographic content in the channel <#" + message.channel.id + "> with the message:\n```" + message.content + "```")
...
if (message.content.startsWith(prefix + 'remind')) {
    ...
    if (wws) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! One minute ago, you told me to remind you to: `' + msg0 + '`.')}, 60000)
    ...
    var msg1 = message.content.replace("?remind 5m ", "")
        if (wws1) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Five minutes ago, you told me to remind you to: `' + msg1 + '`.')}, 300000)
    ...
    var msg2 = message.content.replace("?remind 10m ", "")
            if (wws2) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Ten minutes ago, you told me to remind you to: `' + msg2 + '`.')}, 600000)
    ...
    var msg3 = message.content.replace("?remind 15m ", "")
        if (wws3) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Fifteen minutes ago, you told me to remind you to: `' + msg3 + '`.')}, 900000)
    ...
    var msg4 = message.content.replace("?remind 20m ", "")
        if (wws4) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Twenty minutes ago, you told me to remind you to: `' + msg4 + '`.')}, 1200000)
    ...
    var msg5 = message.content.replace("?remind 25m ", "")
        if (wws5) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Twenty-five minutes ago, you told me to remind you to: `' + msg5 + '`.')}, 1500000)
         message.reply("I'll be reminding you in twenty minutes!")
    }
                var wws6 = message.content.startsWith(prefix + 'remind 30m ')
    var msg6 = message.content.replace("?remind 30m ", "")
    if (wws6) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Thirty minutes ago, you told me to remind you to: `' + msg6 + '`.')}, 1800000)
    ...
    var msg7 = message.content.replace("?remind 35m ", "")
        if (wws7) {
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Thirty-five minutes ago, you told me to remind you to: `' + msg7 + '`.')}, 2100000)
         message.reply("I'll be reminding you in thirty minutes!")
    }
    ...
    if (wws8) {
        ...
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Forty minutes ago, you told me to remind you to: `' + msg8 + '`.')}, 2400000)
    }
    ...
    var msg9 = message.content.replace("?remind 45m ", "")
        ...
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Forty-five minutes ago, you told me to remind you to: `' + msg9 + '`.')}, 2700000)
    }
    ...
    var msg10 = message.content.replace("?remind 50m ", "")
        ...
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Fifty minutes ago, you told me to remind you to: `' + msg10 + '`.')}, 3000000)
    }
    ...
    var msg11 = message.content.replace("?remind 55m ", "")
        ...
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Fifty-five minutes ago, you told me to remind you to: `' + msg11 + '`.')}, 3300000)
    }
    ...
    var msg12 = message.content.replace("?remind 60m ", "" || "?remind 1h", "")
        ...
        bot.setTimeout(function(){ message.author.sendMessage('⏰ Ring, ring! Sixty minutes ago, you told me to remind you to: `' + msg12 + '`.')}, 3600000)
    }
}
...
if (message.content.startsWith(prefix + 'event stop')) {
    ...
    message.guild.channels.find('name', 'announcements').sendMessage("⚠ " + message.author + " has **stopped** event `" + se + "`!")
...
if (message.content.startsWith(prefix + 'choose')) {
    ...
    var spr = wtc.split(",")
    if (!wtc)
        return message.reply("From what choices would you like me to pick from? 🐙")
    if (!wtc.includes(","))
...
if (message.content.startsWith(prefix + 'smug')) {
    ...
    if (message.content.startsWith(prefix + 'dm')) {
        ...
        if (!msg) return;
        if (!link) return;
        if (!link[1]) return message.reply("M-Make sure you include a link o-or chat logs.. (?report [user] [reason], [evidence])").then(m => m.delete(10000))
        if (!things.includes(", ")) return message.reply("M-Make sure you include a link o-or chat logs.. (?report [user] [reason], [evidence])").then(m => m.delete(10000))
        message.guild.channels.find('name', 'nsfw-moderation-room').sendMessage("📋 **[RPT]** Report by: " + message.author + "\n" + link[0] + "\n**Evidence**:\n" + link[1] + "")
        message.author.sendMessage("T-Thank you for the report.. I-I've sent it to the staff..")
    }
    if (message.content.startsWith(prefix + "postart")) {
    const jpgs = [".png", ".jpg", ".jpeg", ".bmp", ".gif", ".tiff"]
    message.delete();
    const embed = new Discord.RichEmbed().setColor(0xFFFF07);
    var artf = message.content.replace("?postart", "")
    var artw = message.content.replace("?postart ", "")
    var eee = message.content.split(", ")
    if (message.channel.id !== '315594693037522944') return;
    if (!message.guild.channels.find('name', 'imadethis_post')) return
    if (!artf) return;
    if (!artf.includes("https")) return message.reply("O-Oh no, I-I hiccuped.. <@&310238978647392256>")
    message.guild.channels.find('name', 'imadethis_post').send({embed: new Discord.RichEmbed().setColor(0xFFFF07).setTitle("Photo sent by: " + message.author.username + "#" + message.author.discriminator).setImage(artw)}).then(message => message.react("❤")).then(message.reply("I-I have successfully posted t-this..!").then(m => m.delete(10000)))
}
if (message.content === prefix + 'phelp') {
    message.reply("In order to use `?postart` correctly, please do the following.\n**Step 1:** DM me with an attachment.\n**Step 2:** I will give you the link to the attachment.\n**Step 3:** Use the link I gave you and do the following:\n`?postart [link]`.").then(m => m.delete(20000))
}
if (message.channel.type == 'dm') {
if (message.attachments.size > 0) {
    message.reply("🖼 **[LINK]** The link to that attachment is:\n" + message.attachments.first().url)
}
}
});
